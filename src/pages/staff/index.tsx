...
import {StaffListApi} from "@/services/admin/staff";
import type {FormValueType} from "@/pages/staff/components/UpdateFormModal";
import UpdateFormModal from "@/pages/staff/components/UpdateFormModal";

const Staff: React.FC = () => {
  const actionRef = useRef<ActionType>();
  const [modalVisit, setModalVisit] = useState<boolean>(false)
  const [currentRecord, setCurrentRecord] = useState<ADMIN_API.StaffListItem | undefined>()
  ...
  const columns: ProColumns<ADMIN_API.StaffListItem>[] = [
    {
      title: '序号',
      dataIndex: 'id',
      hideInSearch: true,
